...
Pour atteindre les objectifs vous devez faire une page web mise en forme correspondant à *votre CV*. 
...
Le projet ne contiendra pas le fichier *trash.txt*

*Vous devez démontrer votre capacité à gérer vos versions, plus que votre capacité à faire un bon CV, bonne page WEB*
